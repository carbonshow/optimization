 ...
 */
public record PartitionData(Map<Integer, Long> addends, int count) {
  /**
   ...
   */
  public Long usedCountOnePartition(Integer addend) {
   ...
   */
  public Long usedCountTotal(Integer addend) {
   ...
   */
  public static Map<Integer,Long> addendsUsedCount(ArrayList<PartitionData> partitions) {
    HashMap<Integer, Long> addendUseCounts = new HashMap<>();
   ...
   */
  public static int totalPartitionsCount(ArrayList<PartitionData> partitions) {
    return partitions.stream().map(PartitionData::count).mapToInt(Integer::intValue).sum();
  }

  @Override
  public String toString() {
    StringBuilder builder = new StringBuilder("Partition: [");
    for (Integer addend : addends.keySet()) {
